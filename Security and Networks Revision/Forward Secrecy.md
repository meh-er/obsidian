...
FS gives assurance that **session keys** will not be compromised even if long-term secrets used in the session key exchange are compromised, limiting damage.